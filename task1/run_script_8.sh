...
TRAIN_DATASETS="deu.rst.pcc eng.dep.scidtb eng.erst.gum eng.rst.rstdt eng.sdrt.stac eng.rst.umuc eus.rst.ert fas.rst.prstc fra.sdrt.annodis nld.rst.nldt por.rst.cstn rus.rst.rrt spa.rst.rststb spa.rst.sctb zho.dep.scidtb zho.rst.gcdt zho.rst.sctb"
TEST_DATASETS="spa.rst.sctb"
...
run_experiment "script8_results" false false 0.0 5e-5 ${DEFAULT_DROPOUT}
