...
TRAIN_DATASETS="deu.rst.pcc eng.dep.scidtb eng.erst.gum eng.rst.rstdt eng.sdrt.stac eng.rst.umuc eus.rst.ert fas.rst.prstc fra.sdrt.annodis fra.sdrt.summre nld.rst.nldt por.rst.cstn rus.rst.rrt spa.rst.rststb spa.rst.sctb zho.dep.scidtb zho.rst.gcdt zho.rst.sctb"
TEST_DATASETS="fra.sdrt.annodis fra.sdrt.summre"
...
run_experiment "script6_results" true true 0.5 7e-5 ${DEFAULT_DROPOUT}
