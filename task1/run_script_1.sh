...
TEST_DATASETS="deu.rst.pcc eng.sdrt.stac fas.rst.prstc nld.rst.nldt zho.dep.scidtb ces.rst.crdt eng.sdrt.msdc"
...
run_experiment "script1_results" false false 0.0 1e-4 0.0
